...
const CommercialCard3Yard = () => {
  const cardData = {
    size: "3-Yard", 
    title: "3 Yard Dumpster",
    description: "Perfect for restaurants and retail stores",
    ...
    alt: "Dumpster Diverz 3-yard commercial dumpster perfect for restaurants, retail stores, and businesses with higher waste volumes",
    link: "/commercial/3-yard-dumpster",
    ariaLabel: "Learn more about 3-yard commercial dumpsters for restaurants and retail stores"
  };
...
export default CommercialCard3Yard;
