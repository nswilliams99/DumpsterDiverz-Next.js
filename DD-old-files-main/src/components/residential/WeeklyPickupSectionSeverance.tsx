...
const WeeklyPickupSectionSeverance = () => {
  const { section } = usePageSection('residential-severance', 'weekly-pickup');
  const serviceFeatures = [
    {
      ...
      title: "Weekly Pickup for All Severance Homes",
      description: "Reliable curbside pickup across Tailholt, Hidden Valley Farm, Timber Ridge, and more."
    },
    {
      icon: <div className="w-12 h-12 bg-diverz-pink rounded-full flex items-center justify-center">
        <Recycle className="w-6 h-6 text-white" aria-hidden="true" />
      </div>,
      title: "Optional Curbside Recycling",
      description: "Add recycling for $10/month — convenient, clean, and picked up the same day as trash."
    },
    {
      icon: <div className="w-12 h-12 bg-diverz-pink rounded-full flex items-center justify-center">
        <Calendar className="w-6 h-6 text-white" aria-hidden="true" />
      </div>,
      title: "Same-Day Setup for New Developments",
      description: "Move-ins and new builds welcome — we provide fast bin delivery for all growth areas."
    },
    {
      icon: <div className="w-12 h-12 bg-diverz-pink rounded-full flex items-center justify-center">
        <MapPin className="w-6 h-6 text-white" aria-hidden="true" />
      </div>,
      title: "Local Drivers, HOA-Friendly Service",
      description: "Our crew knows Severance's layout and provides neat, compliant placement for every cart."
    },
    {
      icon: <div className="w-12 h-12 bg-diverz-pink rounded-full flex items-center justify-center">
        <Handshake className="w-6 h-6 text-white" aria-hidden="true" />
      </div>,
      title: "Flexible Plans, No Long-Term Contracts",
      description: "Month-to-month billing makes it easy for homeowners, renters, and growing families."
    }
  ];
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center mb-20">
          <div className="order-2 lg:order-1">
            <OptimizedImage 
              alt="Weekly residential trash pickup service with proper bin placement in Severance Colorado" 
...
export default WeeklyPickupSectionSeverance;
