...
const WeeklyPickupSectionGreeley = () => {
  const { section } = usePageSection('residential-greeley', 'weekly-pickup');
  const serviceFeatures = [
    {
      icon: <div className="w-12 h-12 bg-diverz-pink rounded-full flex items-center justify-center">
        <Trash2 className="w-6 h-6 text-white" />
      </div>,
      title: "Trash Carts Delivered Across Greeley",
      description: "64 and 96-gallon bins brought to homes in Kelly Farm, Promontory & St. Michaels."
    },
    {
      icon: <div className="w-12 h-12 bg-diverz-pink rounded-full flex items-center justify-center">
        <Recycle className="w-6 h-6 text-white" />
      </div>,
      title: "Optional Recycling, Same-Day Pickup",
      description: "Add curbside recycling for $10/month — picked up with your trash."
    },
    {
      icon: <div className="w-12 h-12 bg-diverz-pink rounded-full flex items-center justify-center">
        <Calendar className="w-6 h-6 text-white" />
      </div>,
      title: "Consistent Weekly Pickup",
      description: "Dependable Monday or Tuesday pickups across neighborhoods and rentals."
    },
    {
      icon: <div className="w-12 h-12 bg-diverz-pink rounded-full flex items-center justify-center">
        <MapPin className="w-6 h-6 text-white" />
      </div>,
      title: "Local Drivers Know Your Block",
      description: "We serve West Greeley, UNC rentals, and nearby homes without confusion."
    },
    {
      icon: <div className="w-12 h-12 bg-diverz-pink rounded-full flex items-center justify-center">
        <Handshake className="w-6 h-6 text-white" />
      </div>,
      title: "Flexible Plans, No Long-Term Contract",
      description: "Students, landlords, and families love our easy month-to-month options."
    }
  ];
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center mb-20">
          <div className="order-2 lg:order-1">
            <OptimizedImage 
              alt="Weekly residential trash pickup service with proper bin placement in Greeley" 
