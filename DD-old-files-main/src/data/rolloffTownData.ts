...
export const rolloffTownsData: RolloffTown[] = [
  ...
  },
  {
    ...
    hero_alt_text: 'Longmont dumpster rental service with roll-off containers',
    hero_subheading: 'Longmont Dumpster Rental - Same-Day Delivery Available',
    local_blurb: 'Need a dumpster rental in Longmont? Dumpster Diverz offers roll-off dumpster rental in Longmont for home renovations, construction debris, roofing projects, and property cleanouts. Our Longmont dumpster rental includes delivery, pickup, and disposal with no hidden fees.',
    meta_description: 'Longmont dumpster rental starting at competitive rates. Roll-off containers for construction, renovation, and cleanout projects. Same-day delivery available. Call 970-888-7274.',
    meta_title: 'Longmont Dumpster Rental | Roll-Off Containers & Same-Day Delivery',
    is_active: true,
    state: 'Colorado',
    embedding: '',
    kml_polygon_data: '',
